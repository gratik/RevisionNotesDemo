...
30-second answer:
- Build-Warning-Triage is about build quality and warning governance. It matters because warning debt compounds and hides real regressions.
- Use it when establishing warning policies that teams can sustain.

2-minute answer:
- Start with the problem Build-Warning-Triage solves in this module and the baseline implementation approach.
...
Bad answer:
- Defines Build-Warning-Triage but skips constraints, alternatives, and production impact.

Strong answer:
- Explains when to choose Build-Warning-Triage, what to compare it against, and how to validate it in tests/operations.
## Interview Timed Drill
- 60 seconds: define Build-Warning-Triage and map it to one concrete implementation in this module.
- 3 minutes: compare Build-Warning-Triage with an alternative, then walk through one failure mode and mitigation.