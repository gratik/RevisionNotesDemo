...
30-second answer:
- Health Check UI is about service health signaling and readiness strategy. It matters because accurate health endpoints prevent bad routing and noisy incidents.
- Use it when separating liveness/readiness/dependency checks by purpose.

2-minute answer:
- Start with the problem Health Check UI solves in this module and the baseline implementation approach.
...
Bad answer:
- Defines Health Check UI but skips constraints, alternatives, and production impact.

Strong answer:
- Explains when to choose Health Check UI, what to compare it against, and how to validate it in tests/operations.
## Interview Timed Drill
- 60 seconds: define Health Check UI and map it to one concrete implementation in this module.
- 3 minutes: compare Health Check UI with an alternative, then walk through one failure mode and mitigation.