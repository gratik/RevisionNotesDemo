...
- **Related Files**: `../Learning/Security/*.cs`
...
- [Security/AuthenticationExamples.cs](../../Learning/Security/AuthenticationExamples.cs) - JWT, Cookie, OAuth patterns
- [Security/AuthorizationExamples.cs](../../Learning/Security/AuthorizationExamples.cs) - Role, claim, policy, and resource authorization patterns
- [Security/EncryptionExamples.cs](../../Learning/Security/EncryptionExamples.cs) - AES, RSA, password hashing, Data Protection API
- [Security/EncryptionAtRestAndInTransit.cs](../../Learning/Security/EncryptionAtRestAndInTransit.cs) - Data-at-rest and TLS-in-transit strategy with key management
- [Security/IdentityServerAndOpenIDConnect.cs](../../Learning/Security/IdentityServerAndOpenIDConnect.cs) - IdP roles, OIDC flow selection, and token validation checks
- [Security/SecureCodingPractices.cs](../../Learning/Security/SecureCodingPractices.cs) - Input validation, SQL injection prevention
...
- [Authentication Methods Comparison](Authentication-Methods-Comparison.md)
- [JWT (JSON Web Tokens)](JWT-JSON-Web-Tokens.md)
- [Encryption vs Hashing](Encryption-vs-Hashing.md)
- [Password Hashing](Password-Hashing.md)
- [Data Encryption Examples](Data-Encryption-Examples.md)
