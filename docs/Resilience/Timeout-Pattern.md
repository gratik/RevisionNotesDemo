...
30-second answer:
- Timeout Pattern is about fault handling and recovery design. It matters because resilience patterns preserve service quality during failures.
- Use it when protecting dependencies with retries, circuit breakers, and timeouts.

2-minute answer:
- Start with the problem Timeout Pattern solves in this module and the baseline implementation approach.
...
Bad answer:
- Defines Timeout Pattern but skips constraints, alternatives, and production impact.

Strong answer:
- Explains when to choose Timeout Pattern, what to compare it against, and how to validate it in tests/operations.
## Interview Timed Drill
- 60 seconds: define Timeout Pattern and map it to one concrete implementation in this module.
- 3 minutes: compare Timeout Pattern with an alternative, then walk through one failure mode and mitigation.