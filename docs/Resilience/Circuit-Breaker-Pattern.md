...
30-second answer:
- Circuit Breaker Pattern is about fault handling and recovery design. It matters because resilience patterns preserve service quality during failures.
- Use it when protecting dependencies with retries, circuit breakers, and timeouts.

2-minute answer:
- Start with the problem Circuit Breaker Pattern solves in this module and the baseline implementation approach.
...
Bad answer:
- Defines Circuit Breaker Pattern but skips constraints, alternatives, and production impact.

Strong answer:
- Explains when to choose Circuit Breaker Pattern, what to compare it against, and how to validate it in tests/operations.
## Interview Timed Drill
- 60 seconds: define Circuit Breaker Pattern and map it to one concrete implementation in this module.
- 3 minutes: compare Circuit Breaker Pattern with an alternative, then walk through one failure mode and mitigation.