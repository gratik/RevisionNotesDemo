...
30-second answer:
- Core Patterns is about consistency strategy across distributed systems. It matters because consistency decisions determine correctness during partial failures.
- Use it when orchestrating workflows with idempotency and compensations.

2-minute answer:
- Start with the problem Core Patterns solves in this module and the baseline implementation approach.
...
Bad answer:
- Defines Core Patterns but skips constraints, alternatives, and production impact.

Strong answer:
- Explains when to choose Core Patterns, what to compare it against, and how to validate it in tests/operations.
## Interview Timed Drill
- 60 seconds: define Core Patterns and map it to one concrete implementation in this module.
- 3 minutes: compare Core Patterns with an alternative, then walk through one failure mode and mitigation.