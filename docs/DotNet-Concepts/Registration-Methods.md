...
30-second answer:
- Registration Methods is about .NET platform and dependency injection fundamentals. It matters because these concepts determine startup wiring and runtime behavior.
- Use it when configuring robust service registration and app composition.

2-minute answer:
- Start with the problem Registration Methods solves in this module and the baseline implementation approach.
...
Bad answer:
- Defines Registration Methods but skips constraints, alternatives, and production impact.

Strong answer:
- Explains when to choose Registration Methods, what to compare it against, and how to validate it in tests/operations.
## Interview Timed Drill
- 60 seconds: define Registration Methods and map it to one concrete implementation in this module.
- 3 minutes: compare Registration Methods with an alternative, then walk through one failure mode and mitigation.