...
30-second answer:
- Stack vs Heap is about allocation, lifetime, and garbage collection behavior. It matters because memory patterns directly affect latency, throughput, and stability.
- Use it when reducing allocation pressure in hot execution paths.

2-minute answer:
- Start with the problem Stack vs Heap solves in this module and the baseline implementation approach.
...
Bad answer:
- Defines Stack vs Heap but skips constraints, alternatives, and production impact.

Strong answer:
- Explains when to choose Stack vs Heap, what to compare it against, and how to validate it in tests/operations.
## Interview Timed Drill
- 60 seconds: define Stack vs Heap and map it to one concrete implementation in this module.
- 3 minutes: compare Stack vs Heap with an alternative, then walk through one failure mode and mitigation.