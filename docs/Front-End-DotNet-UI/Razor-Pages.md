...
30-second answer:
- Razor Pages is about .NET UI stack patterns and frontend integration choices. It matters because UI architecture affects usability, testability, and delivery speed.
- Use it when choosing the right .NET UI approach for product constraints.

2-minute answer:
- Start with the problem Razor Pages solves in this module and the baseline implementation approach.
...
Bad answer:
- Defines Razor Pages but skips constraints, alternatives, and production impact.

Strong answer:
- Explains when to choose Razor Pages, what to compare it against, and how to validate it in tests/operations.
## Interview Timed Drill
- 60 seconds: define Razor Pages and map it to one concrete implementation in this module.
- 3 minutes: compare Razor Pages with an alternative, then walk through one failure mode and mitigation.