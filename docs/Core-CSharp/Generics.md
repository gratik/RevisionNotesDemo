...
30-second answer:
- Generics is about core C# language features and API design. It matters because it directly affects correctness, readability, and maintainability.
- Use it when designing reusable domain and application abstractions.

2-minute answer:
- Start with the problem Generics solves in this module and the baseline implementation approach.
...
Bad answer:
- Defines Generics but skips constraints, alternatives, and production impact.

Strong answer:
- Explains when to choose Generics, what to compare it against, and how to validate it in tests/operations.
## Interview Timed Drill
- 60 seconds: define Generics and map it to one concrete implementation in this module.
- 3 minutes: compare Generics with an alternative, then walk through one failure mode and mitigation.