...
30-second answer:
- Interfaces is about core C# language features and API design. It matters because it directly affects correctness, readability, and maintainability.
- Use it when designing reusable domain and application abstractions.

2-minute answer:
- Start with the problem Interfaces solves in this module and the baseline implementation approach.
...
Bad answer:
- Defines Interfaces but skips constraints, alternatives, and production impact.

Strong answer:
- Explains when to choose Interfaces, what to compare it against, and how to validate it in tests/operations.
## Interview Timed Drill
- 60 seconds: define Interfaces and map it to one concrete implementation in this module.
- 3 minutes: compare Interfaces with an alternative, then walk through one failure mode and mitigation.