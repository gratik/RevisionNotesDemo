...
- Understand the main concepts covered in HealthChecks.
...
- Web API basics
- Operational readiness concepts

## Runnable examples

- HealthCheckExamples.cs - Topic implementation and demonstration code
