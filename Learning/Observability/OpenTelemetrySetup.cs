// ==============================================================================
// Vendor-agnostic instrumentation framework
// ==============================================================================
// WHAT IS THIS?
// {WHAT}
//
...
public class OpenTelemetrySetup
{
    ...
    {
        Console.WriteLine("\n╔══════════════════════════════════════════════════════╗");
        Console.WriteLine("║  Vendor-agnostic instrumentation framework");
        Console.WriteLine("╚══════════════════════════════════════════════════════╝\n");
    ...
    private static void DisplayOverview()
    {
        ...
        Console.WriteLine("This section covers vendor-agnostic instrumentation framework\n");
