# LINQ and Queries Guide

## Learning goals

- Understand the main concepts covered in LINQAndQueries.
...
- IQueryableVsIEnumerable.cs - Topic implementation and demonstration code
- LINQExamples.cs - Topic implementation and demonstration code
