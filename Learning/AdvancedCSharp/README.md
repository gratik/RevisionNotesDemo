...
- Understand the main concepts covered in AdvancedCSharp.
...
- Basic reflection and metadata concepts

## Runnable examples

- ReflectionAndAttributes.cs - Topic implementation and demonstration code
