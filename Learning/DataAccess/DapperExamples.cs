...
// WHAT IS DAPPER?
// ---------------
// A lightweight micro-ORM that maps SQL results to objects with minimal overhead.
// You write SQL, Dapper handles parameterization and object mapping.
//
// WHY IT MATTERS
// --------------
// - Very fast for read-heavy workloads
// - Full control over SQL and query plans
// - Small surface area and low complexity
// - Works well alongside EF Core
//
// WHEN TO USE
// -----------
// - YES: Performance-critical reads and reporting
// - YES: Complex queries where SQL control matters
// - YES: Existing databases or stored procedures
//
// WHEN NOT TO USE
// ---------------
// - NO: When you need change tracking and rich graph updates
// - NO: When a code-first workflow is required
//
// REAL-WORLD EXAMPLE
// ------------------
// Analytics service:
