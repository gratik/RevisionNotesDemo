...
// ==============================================================================
// PURPOSE:
//   Master ADO.NET - the foundation of all .NET data access.
//   SqlConnection, SqlCommand, SqlDataReader - the building blocks.
//
// WHY ADO.NET:
//   - Maximum performance
//   - Full control
//   - Understanding the foundation
//   - Dapper/EF built on this
//
// WHAT YOU'LL LEARN:
//   1. Connection management and pooling
//   2. SqlCommand patterns
//   3. SqlDataReader efficient reading
//   4. Parameterized queries
//   5. Async ADO.NET
//   6. Common pitfalls
//
// KEY PRINCIPLE:
//   Always dispose connections properly. Connection pooling handles reuse.
// ==============================================================================
