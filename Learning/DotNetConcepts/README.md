...
- Understand the main concepts covered in DotNetConcepts.
...
- Core C# familiarity
- Application startup and DI basics

## Runnable examples

- DependencyInjectionDemo.cs - Topic implementation and demonstration code
...
- [Primary](../../docs/DotNet-Concepts.md)
