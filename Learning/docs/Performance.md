...
- [Performance/SpanAndMemory.cs](../Performance/SpanAndMemory.cs) - Span<T>, Memory<T>, stackalloc examples
- [Performance/BenchmarkingExamples.cs](../Performance/BenchmarkingExamples.cs) - BenchmarkDotNet patterns
- [Performance/OptimizationTechniques.cs](../Performance/OptimizationTechniques.cs) - ArrayPool, StringBuilder, caching
