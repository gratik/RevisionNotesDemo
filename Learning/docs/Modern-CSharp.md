...
- [ModernCSharp/PatternMatchingExamples.cs](../ModernCSharp/PatternMatchingExamples.cs)
- [ModernCSharp/NullableReferenceTypes.cs](../ModernCSharp/NullableReferenceTypes.cs)
- [ModernCSharp/InitOnlyProperties.cs](../ModernCSharp/InitOnlyProperties.cs)
- [ModernCSharp/RecordsAndRecordStructs.cs](../ModernCSharp/RecordsAndRecordStructs.cs)
